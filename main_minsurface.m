...
% L-BFGS
s_opts = struct("s", 1, "sigma", 0.5, "gamma", 0.1, "m", 10, "epsilon", 1e-5, "delta", 1e-4, "H", eye(dim_x));
...
% [x, opt_val, f_k, grad_k, T, method] = L_BFGS (obj, grad, x0, s_opts);
...
% title("Minimal Surface with Boundary $r(x,y)=1+\sin(2\pi x)$ ($m=n=75$)", "interpreter", "latex")
