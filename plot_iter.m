...
% method  name of the optimization method
    ...
    title({"Plot of $|f(X^k)-f^*|/\max\{1,\,|f^*|\}$ v.s. No. of Iterations", "for "+method}, "interpreter", "latex")
